...
const Carousel = () => {
    // NGO-focused carousel items with relevant content
    const carouselItems: CarouselItem[] = [
        {
            id: 1,
            title: 'Education for All',
            description: 'Empowering underprivileged children with quality education and learning resources.',
        ...
        },
        {
            ...
            description: 'Providing essential medical care and health awareness to remote communities.',
            image: '/img/slide-02.jpg',
            ctaText: 'Donate to Healthcare',
            ctaLink: '#',
        },
        {
            id: 3,
            title: 'Women Empowerment',
            description: 'Creating opportunities for women through skill development and livelihood programs.',
        ...
        },
        {
            ...
            description: 'Protecting our planet through tree plantation and sustainable development projects.',
            image: '/img/slide-04.jpg',
            ctaText: 'Join Green Mission',
            ctaLink: '#',
        },
        {
            id: 5,
            title: 'Community Development',
            description: 'Building stronger communities through infrastructure and social welfare programs.',
    ...
    return (
        ...
        >
            ...
            <div
                ...
                tabIndex={0}
                role="region"
                aria-label="NGO initiatives carousel"
            >
                {/* Slides */}
                <div
                            ...
                            <div className="relative h-96 md:h-96 lg:h-200 xl:h-200">
                                ...
                                <div className="relative h-full flex flex-col items-center justify-center p-4 md:p-8 text-white">
                                    <div className="max-w-3xl text-center">
                                        <h2 className="text-3xl md:text-5xl lg:text-6xl font-lexend mb-4 md:mb-6 drop-shadow-lg">
                                            {item.title}
                                        </h2>
